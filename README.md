...
This project also requires the Think Stats libraries developed by Allen B. Downey.  Instructions for installing Think Stats can be found [here](https://greenteapress.com/thinkstats2/thinkstats2.pdf).
